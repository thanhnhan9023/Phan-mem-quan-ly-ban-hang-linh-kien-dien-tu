...
namespace QuanLyVatLieuXayDung.GUI
{
    public class ExcelExport
    {
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case "bangdiem":
                    ...
                    arrByte = File.ReadAllBytes( "bangdiem.xlsx").ToArray();
                    break;
                ...
                case "PhieuNhap":
                    ...
                    arrByte = File.ReadAllBytes("NhapHang.xlsx").ToArray();
                    break;
                    #endregion
            }
            // Get stream
        ...
        public void ThanhPhanB1(ref Dictionary<string, string> replacer)
        {
            if (replacer != null)
            {
        ...
        public void ThanhPhanB1BangDiem(ref Dictionary<string, string> replacer, int pTong,String masv,String hoten)
        {
            if (replacer != null)
            {
                ...
                replacer.Add("%MaSoSinhVien",masv);
                replacer.Add("%HoVaTen", hoten);
                

            }
        }
        public bool ExportNhap(List<HoaDon_Nhap> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            ThanhPhanB1(ref replacer);
          //  BuildReplacerCurrentDate(ref replacer);

            return OutSimpleReport(dataSource, replacer, "PhieuNhap", isPrintPreview, ref fileName);
        }

        //public bool ExportBangDiem(List<ChiTietDiem> dataSource, ref string fileName, bool isPrintPreview,String masv,String hoten)
        //{
        //    // Check if data is null
        //    if (dataSource == null || (dataSource != null && dataSource.Count == 0))
        //    {
        ...
        //    ThanhPhanB1BangDiem(ref replacer, dataSource.Count,masv,hoten);
        //    //  BuildReplacerCurrentDate(ref replacer);

        //    return OutSimpleReport(dataSource, replacer, "bangdiem", isPrintPreview, ref fileName);
        //}
